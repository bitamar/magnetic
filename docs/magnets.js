...
var _user$project$Magnet_Model$Magnet = F5(
	function (a, b, c, d, e) {
		return {id: a, word: b, position: c, drag: d, rotation: e};
	});
var _user$project$Magnet_Model$Drag = F4(
	function (a, b, c, d) {
		return {start: a, current: b, distanceFromCenter: c, side: d};
	});
var _user$project$Magnet_Model$Right = {ctor: 'Right'};
var _user$project$Magnet_Model$Left = {ctor: 'Left'};

var _user$project$Magnets_Model$emptyModel = _elm_lang$core$Dict$empty;

var _user$project$App_Model$emptyModel = {magnets: _user$project$Magnets_Model$emptyModel};
var _user$project$App_Model$Model = function (a) {
	return {magnets: a};
};

var _user$project$Http_Update$decodePosition = A3(
	_elm_lang$core$Json_Decode$object2,
	_elm_lang$mouse$Mouse$Position,
...
var _user$project$Http_Update$decodeSide = function (side) {
	return _elm_lang$core$Json_Decode$succeed(_user$project$Magnet_Model$Left);
};
var _user$project$Http_Update$decodeDrag = A5(
	_elm_lang$core$Json_Decode$object4,
	_user$project$Magnet_Model$Drag,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'current', _user$project$Http_Update$decodePosition),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'start', _user$project$Http_Update$decodePosition),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'distanceFromCenter', _elm_lang$core$Json_Decode$float),
	A2(
		_elm_lang$core$Json_Decode$andThen,
		A2(_elm_lang$core$Json_Decode_ops[':='], 'side', _elm_lang$core$Json_Decode$string),
		_user$project$Http_Update$decodeSide));
var _user$project$Http_Update$decodeMagnet = A6(
	_elm_lang$core$Json_Decode$object5,
	_user$project$Magnet_Model$Magnet,
	...
	A2(_elm_lang$core$Json_Decode_ops[':='], 'position', _user$project$Http_Update$decodePosition),
	_elm_lang$core$Json_Decode$maybe(
		A2(_elm_lang$core$Json_Decode_ops[':='], 'drag', _user$project$Http_Update$decodeDrag)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'rotation', _elm_lang$core$Json_Decode$float));
var _user$project$Http_Update$decodeMagnets = _elm_lang$core$Json_Decode$dict(_user$project$Http_Update$decodeMagnet);
var _user$project$Http_Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
...
var _user$project$Http_Update$FetchFail = function (a) {
	return {ctor: 'FetchFail', _0: a};
};
var _user$project$Http_Update$FetchSucceed = function (a) {
	return {ctor: 'FetchSucceed', _0: a};
};
var _user$project$Http_Update$getMagnets = function () {
	var url = 'https://peaceful-refuge.herokuapp.com/';
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Http_Update$FetchFail,
		_user$project$Http_Update$FetchSucceed,
		A2(_evancz$elm_http$Http$get, _user$project$Http_Update$decodeMagnets, url));
}();
var _user$project$Http_Update$init = _user$project$Http_Update$getMagnets;

var _user$project$Magnet_Utils$setDragAt = F2(
	function (_p0, position$) {
		var _p1 = _p0;
		var _p7 = _p1.drag;
		...
		var rotation$ = _p1.rotation + rotationDelta;
		return A5(
			_user$project$Magnet_Model$Magnet,
			_p1.id,
			_p1.word,
			...
			A2(
				...
				function (_p5) {
					var _p6 = _p5;
					return A4(_user$project$Magnet_Model$Drag, _p6.start, position$, _p6.distanceFromCenter, _p6.side);
				},
				_p7),
			rotation$);
	});
var _user$project$Magnet_Utils$setDragStart = F2(
	function (_p8, position$) {
		var _p9 = _p8;
		var _p11 = _p9.position;
		var distanceFromMagnetCenter = function (_p10) {
			return _elm_lang$core$Basics$sqrt(
				_elm_lang$core$Basics$toFloat(_p10));
		}(
			Math.pow(_p11.x - position$.x, 2) + Math.pow(_p11.y - position$.y, 2));
		var side = (_elm_lang$core$Native_Utils.cmp(position$.x, _p11.x) < 0) ? _user$project$Magnet_Model$Left : _user$project$Magnet_Model$Right;
		return A5(
			_user$project$Magnet_Model$Magnet,
			_p9.id,
			_p9.word,
			_p11,
			_elm_lang$core$Maybe$Just(
				A4(_user$project$Magnet_Model$Drag, position$, position$, distanceFromMagnetCenter, side)),
			_p9.rotation);
	});
var _user$project$Magnet_Utils$getPosition = function (_p12) {
	var _p13 = _p12;
	...
	if (_p14.ctor === 'Nothing') {
		...
		var _p16 = _p14._0.start;
		var _p15 = _p14._0.current;
		return A2(_elm_lang$mouse$Mouse$Position, (_p17.x + _p15.x) - _p16.x, (_p17.y + _p15.y) - _p16.y);
	}
};
var _user$project$Magnet_Utils$setDragEnd = F2(
	function (_p18, position$) {
		var _p19 = _p18;
		return A5(
			_user$project$Magnet_Model$Magnet,
			_p19.id,
			_p19.word,
			_user$project$Magnet_Utils$getPosition(_p19),
			_elm_lang$core$Maybe$Nothing,
			_p19.rotation);
	});

var _user$project$Magnets_Update$getDraggedMagnet = function (model) {
	var isMagnetDragged = function (magnet) {
		var _p0 = magnet.drag;
		if (_p0.ctor === 'Just') {
			return true;
		} else {
...
var _user$project$Magnets_Update$updateMagnet = F2(
	function (model, magnet) {
		return A3(
			_elm_lang$core$Dict$update,
			magnet.id,
			function (_p1) {
				return _elm_lang$core$Maybe$Just(magnet);
			},
			model);
	});
var _user$project$Magnets_Update$update = F2(
	function (model, msg) {
		var _p2 = msg;
		switch (_p2.ctor) {
			case 'MouseMove':
				var model$ = function () {
					var _p3 = _user$project$Magnets_Update$getDraggedMagnet(model);
					if (_p3.ctor === 'Nothing') {
						return model;
					} else {
						return A2(
							_user$project$Magnets_Update$updateMagnet,
							model,
							A2(_user$project$Magnet_Utils$setDragAt, _p3._0, _p2._0));
					}
				}();
				return {ctor: '_Tuple2', _0: model$, _1: _elm_lang$core$Platform_Cmd$none};
			case 'MouseUp':
				var model$ = function () {
					var _p4 = _user$project$Magnets_Update$getDraggedMagnet(model);
					if (_p4.ctor === 'Nothing') {
						return model;
					} else {
						return A2(
							_user$project$Magnets_Update$updateMagnet,
							model,
							A2(_user$project$Magnet_Utils$setDragEnd, _p4._0, _p2._0));
					}
				}();
				return {ctor: '_Tuple2', _0: model$, _1: _elm_lang$core$Platform_Cmd$none};
			default:
				var magnet$ = A2(_user$project$Magnet_Utils$setDragStart, _p2._0, _p2._1);
				var model$ = A2(_user$project$Magnets_Update$updateMagnet, model, magnet$);
				return {ctor: '_Tuple2', _0: model$, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _user$project$Magnets_Update$MouseUp = function (a) {
	return {ctor: 'MouseUp', _0: a};
};
var _user$project$Magnets_Update$MouseMove = function (a) {
	return {ctor: 'MouseMove', _0: a};
};
var _user$project$Magnets_Update$DragStart = F2(
	function (a, b) {
		return {ctor: 'DragStart', _0: a, _1: b};
	});

var _user$project$App_Update$MouseUp = function (a) {
	return {ctor: 'MouseUp', _0: a};
};
var _user$project$App_Update$MouseMove = function (a) {
	return {ctor: 'MouseMove', _0: a};
};
var _user$project$App_Update$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$mouse$Mouse$moves(_user$project$App_Update$MouseMove),
				_elm_lang$mouse$Mouse$ups(_user$project$App_Update$MouseUp)
			]));
};
var _user$project$App_Update$Magnets = function (a) {
	return {ctor: 'Magnets', _0: a};
};
var _user$project$App_Update$Http = function (a) {
	return {ctor: 'Http', _0: a};
};
var _user$project$App_Update$init = {
	ctor: '_Tuple2',
	_0: _user$project$App_Model$emptyModel,
	_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$App_Update$Http, _user$project$Http_Update$init)
};
var _user$project$App_Update$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'Http':
				var _p1 = A2(_user$project$Http_Update$update, _p0._0, model.magnets);
				var magnets$ = _p1._0;
				var cmds = _p1._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{magnets: magnets$}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$App_Update$Http, cmds)
				};
			case 'Magnets':
				var _p2 = A2(_user$project$Magnets_Update$update, model.magnets, _p0._0);
				var magnets$ = _p2._0;
				var cmds = _p2._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{magnets: magnets$}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$App_Update$Magnets, cmds)
				};
			case 'MouseMove':
				var _p3 = A2(
					_user$project$Magnets_Update$update,
					model.magnets,
					_user$project$Magnets_Update$MouseMove(_p0._0));
				var magnets$ = _p3._0;
				var cmds = _p3._1;
				return {
					ctor: '_Tuple2',
			...
			default:
				var _p4 = A2(
					_user$project$Magnets_Update$update,
					model.magnets,
					_user$project$Magnets_Update$MouseUp(_p0._0));
				var magnets$ = _p4._0;
				var cmds = _p4._1;
				return {
					ctor: '_Tuple2',
...
var _user$project$Magnets_View$px = function (number) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(number),
		'px');
};
var _user$project$Magnets_View$printMagnet = function (magnet) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
					_elm_lang$core$Json_Decode$map,
					_user$project$Magnets_Update$DragStart(magnet),
					_elm_lang$mouse$Mouse$position)),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						ctor: '_Tuple2',
						_0: 'left',
						_1: _user$project$Magnets_View$px(
							_user$project$Magnet_Utils$getPosition(magnet).x - 50)
					},
						{
						ctor: '_Tuple2',
						_0: 'top',
						_1: _user$project$Magnets_View$px(
							_user$project$Magnet_Utils$getPosition(magnet).y - 15)
					},
						{
						ctor: '_Tuple2',
						_0: 'transform',
						_1: A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(magnet.rotation),
								'deg)'))
					}
					]))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text(magnet.word)
			]));
};
var _user$project$Magnets_View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('magnets')
					]),
				A2(
					_elm_lang$core$List$map,
					_user$project$Magnets_View$printMagnet,
					_elm_lang$core$Dict$values(model)))
			]));
};
...
var _user$project$App_View$viewMainContent = function (model) {
	return A2(
		...
		_user$project$App_Update$Magnets,
		_user$project$Magnets_View$view(model.magnets));
};
...
var _user$project$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$App_Update$init, view: _user$project$App_View$view, update: _user$project$App_Update$update, subscriptions: _user$project$App_Update$subscriptions})
};
